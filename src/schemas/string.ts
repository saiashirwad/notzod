...
export class StringSchema extends Schema<string> {
	...
	compile(): void {
		...
		if (this.minLength !== undefined) {
			...
			checks.push(`  return { success: false, error: { path, message: "String must be at least ${this.minLength} characters", data: value } };`)
			checks.push('}')
		}
		...
		if (this.maxLength !== undefined) {
			...
			checks.push(`  return { success: false, error: { path, message: "String must be at most ${this.maxLength} characters", data: value } };`)
			checks.push('}')
		}
